import { type NativeProps, type LinkPressEvent, type LinkLongPressEvent, type TaskListItemPressEvent } from './EnrichedMarkdownTextNativeComponent';
...
export interface EnrichedMarkdownTextProps extends Omit<NativeProps, 'markdownStyle' | 'style' | 'onLinkPress' | 'onLinkLongPress' | 'onTaskListItemPress' | 'md4cFlags' | 'enableLinkPreview'> {
    /**
...
export declare const EnrichedMarkdownText: ({ markdown, markdownStyle, containerStyle, onLinkPress, onLinkLongPress, onTaskListItemPress, enableLinkPreview, selectable, md4cFlags, allowFontScaling, maxFontSizeMultiplier, allowTrailingMargin, flavor, streamingAnimation, ...rest }: EnrichedMarkdownTextProps) => import("react/jsx-runtime").JSX.Element;
